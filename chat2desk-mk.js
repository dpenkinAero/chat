...
(function () {
    ...
    function injectOnlineChatThemeIntoShadow(shadowRoot) {
      ...
      var css =
        ...
        ".chat24-container .widget .messenger," +
        ".chat24-container .widget .messengers--vertical," +
        ".chat24-container .widget .messengers--horizontal{" +
        ...
        ".chat24-container .online-chat:not(.online-chat--collapsed)~div .widget{" +
        "display:none!important;visibility:hidden!important;pointer-events:none!important;}" +
    ...
    function initChat24Skip() {
      ...
      function refreshMkChatLayoutOnce() {
      ...
      if (!window.__mkChat24OpenListeners) {
        window.__mkChat24OpenListeners = true;
      ...
      root.addEventListener("click", function (evt) {
        ...
        setTimeout(function () {
          ...
          setTimeout(refreshMkChatLayoutOnce, 120);
        }, 0);
      }, true);
